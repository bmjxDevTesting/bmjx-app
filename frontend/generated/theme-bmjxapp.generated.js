...
import stylesCss from 'themes/bmjxapp/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/bmjxapp/components/vaadin-button.css';
import vaadinPasswordFieldCss from 'themes/bmjxapp/components/vaadin-password-field.css';
import vaadinTextAreaCss from 'themes/bmjxapp/components/vaadin-text-area.css';
import vaadinTextFieldCss from 'themes/bmjxapp/components/vaadin-text-field.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_bmjxapp_componentCss']) {
    registerStyles(
      'vaadin-button',
    ...
    document['_vaadintheme_bmjxapp_componentCss'] = true;
  }
