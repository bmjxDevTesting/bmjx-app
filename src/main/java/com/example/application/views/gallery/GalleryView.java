...
@Tag("gallery-view")
@JsModule("./views/gallery/gallery-view.ts")
public class GalleryView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public GalleryView() {
        addClassNames("gallery-view", "flex", "flex-col", "h-full");
