package com.example.application.views.systemshealth;


import com.example.application.views.MainLayout;
import com.example.application.views.systemshealth.ServiceHealth.Status;
...
@PageTitle("Systems Health")
@Route(value = "SystemsStats", layout = MainLayout.class)
public class SystemsHealthView extends Main {

    public SystemsHealthView() {
        addClassName("systems-health-view");
